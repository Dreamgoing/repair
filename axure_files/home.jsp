  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u2" class="ax_image">
        <img id="u2_img" class="img " src="images/finance/u0.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u6" class="ax_水平线">
        ...
        <img id="u6_line" class="img " src="images/login/u4_line.png" alt="u6_line"/>
      </div>

      <!-- Unnamed (垂直线) -->
      <div id="u7" class="ax_垂直线">
        ...
        <img id="u7_line" class="img " src="images/login/u5_line.png" alt="u7_line"/>
      </div>
      ...
      <div id="u10" class="ax_形状">
        ...
        <div id="u11" class="text">
          <p><span><a href="finance.jsp">财务管理</a> </span></p>
        </div>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u12" class="ax_形状">
        <img id="u12_img" class="img " src="images/finance/u9.png"/>
        <!-- Unnamed () -->
        <div id="u13" class="text">
          <p><span><a href="income_expenses.jsp">收支管理</a> </span></p>
        </div>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u14" class="ax_形状">
        <img id="u14_img" class="img " src="images/finance/u9.png"/>
        <!-- Unnamed () -->
        <div id="u15" class="text">
          <p><span><a href="report.jsp">报表管理</a> </span></p>
        </div>
      </div>
    </div>
  </body>
