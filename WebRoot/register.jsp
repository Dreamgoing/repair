  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u5" class="ax_垂直线">
        ...
        <img id="u5_line" class="img " src="images/login/u5_line.png" alt="u5_line"/>
      </div>
      ...
      <!-- Unnamed (文本框) -->
      <div id="u10" class="ax_文本框">
        <input id="u10_input" type="text" value=""/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u11" class="ax_文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u14" class="ax_文本框">
        <input id="u14_input" type="password" value=""/>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u15" class="ax_形状">
        <img id="u15_img" class="img " src="images/report/u63.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u17" class="ax_形状">
        <img id="u17_img" class="img " src="images/report/u63.png"/>
        <!-- Unnamed () -->
